  ...
  return (
    <div className="calculator-container">
      ...
      <div className="form-section">
        ...
        <label>Diesel Mileage (km/l): <input name="dieselMileage" type="number" value={inputs.dieselMileage} onChange={handleChange} /></label>
        ...
        <label>Diesel Price (₹/litre): <input name="dieselPrice" type="number" value={inputs.dieselPrice} onChange={handleChange} /></label>
